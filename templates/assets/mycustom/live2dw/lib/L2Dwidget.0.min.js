...
webpackJsonpL2Dwidget([0], {
    76: function(t, e, i) {
        ...
        var r, o = i(38), n = i(80), s = i(77), a = i(78), _ = i(84), h = i(81), l = i(79), $ = i(39), u = (r = $,
        r && r.__esModule ? r : {
            default: r
        }), p = i(37);
        var c = null
        ...
        e.theRealInit = function() {
            (0,
            n.createElement)(),
            n.currCanvas.addEventListener && (window.addEventListener("click", E),
            ...
            var t = n.currCanvas.getBoundingClientRect()
              ...
              , $ = -e
              , P = e;
            (y = new a.L2DViewMatrix).setScreenRect(i, r, $, P),
            ...
            S = u.default.mobile() && o.config.mobile.scale || o.config.model.scale,
            y.adjustScale(0, 0, S);
            var S;
            (m = new a.L2DMatrix44).multScale(1, t.width / t.height),
    ...
    77: function(t, e, i) {
        ...
        (function(t) {
            ...
            o.prototype.calcClippedDrawTotalBounds = function(t, e) {
                for (var i = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = i > r ? i : r, n = o, s = o, a = 0, _ = 0, h = e.clippedDrawContextList.length, l = 0; l < h; l++) {
                    var $ = e.clippedDrawContextList[l].drawDataIndex
                      , u = t._$C2($);
                    if (u._$yo()) {
                        for (var p = u.getTransformedPoints(), c = p.length, f = [], g = [], d = 0, y = B._$i2; y < c; y += B._$No)
                            f[d] = p[y],
                            g[d] = p[y + 1],
                            d++;
            ...
            u.prototype._$oo = function(t, e) {
                ...
                this.p1._$xT();
                var r, o, n = -Math.atan2(this.p1.y - this.p2.y, this.p1.x - this.p2.x), s = Math.cos(n), a = Math.sin(n), _ = 9.8 * this.p2._$p, h = this._$Db * vt._$bS, l = _ * Math.cos(n - h);
                r = l * a,
                o = l * s;
                var $ = -this.p1.fx * a * a
                  , u = -this.p1.fy * a * s
            ...
            S._$Z2 = function(t, e, i, r) {
                ...
                if (4 == o) {
                    var S, v = r[n[0]], L = r[n[1]], M = r[n[2]], E = r[n[3]], x = r[n[4]], A = r[n[5]], I = r[n[6]], w = r[n[7]], D = r[n[8]], O = r[n[9]], b = r[n[10]], R = r[n[11]], F = r[n[12]], C = r[n[13]], N = r[n[14]], B = r[n[15]], G = ($ = s[0],
                    u = s[1],
                    P = s[2],
                    s[3]);
            ...
            S._$Vr = function(t, e, i, r, o, n, s, a) {
                ...
                if (_ <= 0) {
                    ...
                    l[1])
                      ...
                      , Y = st * b * m;
                    for (c = 0; c < $; )
                        n[u] = R * L[c] + F * M[c] + C * E[c] + N * x[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c],
                        ++c,
                    ...
                    b = l[1],
                    l[2]), at = l[3], _t = 1 - at, ht = _t * (V = 1 - st) * (k = 1 - b) * (g = 1 - m), lt = _t * V * k * m, $t = _t * V * b * g, ut = _t * V * b * m, pt = _t * st * k * g, ct = _t * st * k * m, ft = _t * st * b * g, gt = _t * st * b * m, dt = at * V * k * g, yt = at * V * k * m, mt = at * V * b * g, Tt = at * V * b * m, Pt = at * st * k * g, St = at * st * k * m, vt = at * st * b * g, Lt = at * st * b * m;
                    for (c = 0; c < $; )
                        n[u] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + dt * Z[c] + yt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + St * rt[c] + vt * ot[c] + Lt * nt[c],
                        ++c,
                    ...
                    for (var Mt = 1 << _, Et = new Float32Array(Mt), xt = 0; xt < Mt; xt++) {
                        for (var At = xt, It = 1, wt = 0; wt < _; wt++)
                            It *= At % 2 == 0 ? 1 - l[wt] : l[wt],
                            At /= 2;
                        Et[xt] = It
                    }
            ...
            D.prototype._$Ur = function(t) {
                ...
                for (var e = t._$v2(), i = this._$Ob.length - 1; i >= 0; --i) {
                    ...
                    if (r == I._$ds && (r = t.getParamIndex(this._$Ob[i].getParamID())),
                    t._$Xb(r))
                        return !0
                }
                return !1
            ...
            D.prototype._$Q2 = function(t, e) {
                for (var i, r, o = this._$Ob.length, n = t._$v2(), s = 0, a = 0; a < o; a++) {
                    var _ = this._$Ob[a];
                    if ((i = _.getParamIndex(n)) == I._$ds && (i = t.getParamIndex(_.getParamID()),
                    _._$Pb(i, n)),
                    i < 0)
                            ...
                            if ("$" != n) {
                                if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
                                    ...
                                    if (l >= 0) {
                                        ...
                                        s._$4P = new String(t,h,l - h)) : w.startsWith(t, h, F._$ar) ? (s._$4P = new String(t,h + 7,l - h - 7),
                ...
                for (var g = r.length, d = dt._$2o(); ; ) {
                    ...
                    for (s = 0; s < g; ++s) {
                        ...
                        if (null != m) {
                            ...
                            (null == T || T == d || this.getBaseDataIndex(T) >= 0) && (this._$3S.push(m),
                            this._$db.push(n[s]),
                            r[s] = null,
                            y = !0)
                        }
            ...
            function X() {
                i || (M.prototype.constructor.call(this),
            ...
            z.prototype._$Nr = function(t, e) {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    o <= 0) {
                        ...
                        v = s[2],
                        s[3])
                          , V = (p = E._$fL + (x._$fL - E._$fL) * h,
                        c = A._$fL + (I._$fL - A._$fL) * h,
                        L = w._$fL + (D._$fL - w._$fL) * h,
                        M = O._$fL + (b._$fL - O._$fL) * h,
            ...
            z.prototype._$nb = function(t, e, i, r, o, n, s) {
                this != e._$GT() && console.log("### assert!! ### ");
                for (var a, _, h = e, l = null != h._$Wr ? h._$Wr : h._$Yr, $ = Math.sin(vt._$bS * l._$qT), u = Math.cos(vt._$bS * l._$qT), p = h.getTotalScale(), c = l.reflectX ? -1 : 1, f = l.reflectY ? -1 : 1, g = u * p * c, d = -$ * p * f, y = $ * p * c, m = u * p * f, T = l._$fL, P = l._$gL, S = o * s, v = n; v < S; v += s)
                    a = i[v],
                    _ = i[v + 1],
                    r[v] = g * a + d * _ + T,
                    r[v + 1] = y * a + m * _ + P
                        ...
                        if ("#" != n)
                            if ("$" != n) {
                                if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
                                    ...
                                    if (u >= 0) {
                                        var a = new N;
                                        w.startsWith(t, $, J._$cs) ? (a._$RP = N._$hs,
                                        a._$4P = w.createString(t, $, u - $)) : w.startsWith(t, $, J._$ar) ? (a._$4P = w.createString(t, $ + 7, u - $ - 7),
                                        w.startsWith(t, $ + 7, "ANCHOR_X") ? a._$RP = N._$xs : w.startsWith(t, $ + 7, "ANCHOR_Y") ? a._$RP = N._$us : w.startsWith(t, $ + 7, "SCALE_X") ? a._$RP = N._$qs : w.startsWith(t, $ + 7, "SCALE_Y") ? a._$RP = N._$Ys : w.startsWith(t, $ + 7, "X") ? a._$RP = N._$ws : w.startsWith(t, $ + 7, "Y") && (a._$RP = N._$Ns)) : (a._$RP = N._$Fr,
                                        a._$4P = w.createString(t, $, u - $)),
                                        e.motions.push(a);
                                        var _ = 0
                                          , h = [];
            ...
            Z.transformPoints_sdk2 = function(e, i, r, o, n, s, a, _) {
                for (var h, l, $, u = r * n, p = 0, c = 0, f = 0, g = 0, d = 0, y = 0, m = !1, T = o; T < u; T += n) {
                    ...
                    (P = v * a) < 0 || S < 0 || a <= P || _ <= S) {
                            ...
                            if (v <= 0)
                                if (L <= 0) {
                                    var w = s[2 * (0 + 0 * M)]
                                      ...
                                      , C = p - 2 * f - 2 * d
                                      , N = c - 2 * g - 2 * y;
                                    (B = .5 * (v - -2)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G),
                                    ...
                                    O = p - 2 * f + 3 * d,
                                    b = c - 2 * g + 3 * y;
                                    (B = .5 * (v - -2)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G),
                                    i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                                } else {
                                    (k = 0 | S) == _ && (k = _ - 1);
                                ...
                                if (L <= 0) {
                                    ...
                                    R = p + 3 * f - 2 * d,
                                    F = c + 3 * g - 2 * y;
                                    (B = .5 * (v - 1)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G),
                                    i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                                } else if (L >= 1) {
                                    C = s[2 * (a + _ * M)],
                                    ...
                                    w = p + 3 * f + 3 * d,
                                    D = c + 3 * g + 3 * y;
                                    (B = .5 * (v - 1)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G),
                                    i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                                } else {
                                    var k;
                        ...
                        h = 2 * ((0 | P) + (0 | S) * (a + 1)),
                        (l = P - (0 | P)) + ($ = S - (0 | S)) < 1 ? (i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (a + 1)] * $,
            ...
            Z.prototype.transformPoints_sdk1 = function(t, e, i, r, o, n, s) {
                for (var a, _, h, l, $, u, p, c = e, f = this._$o, g = this._$A, d = o * s, y = null != c._$hr ? c._$hr : c._$Cr, m = n; m < d; m += s)
                    at._$ts ? (a = i[m],
                    _ = i[m + 1],
                    a < 0 ? a = 0 : a > 1 && (a = 1),
                    _ < 0 ? _ = 0 : _ > 1 && (_ = 1),
                    ...
                    p = (_ = i[m + 1] * g) - (0 | _),
                    $ = 2 * ((0 | a) + (0 | _) * (f + 1))),
                    u + p < 1 ? (r[m] = y[$] * (1 - u - p) + y[$ + 2] * u + y[$ + 2 * (f + 1)] * p,
                    r[m + 1] = y[$ + 1] * (1 - u - p) + y[$ + 3] * u + y[$ + 2 * (f + 1) + 1] * p) : (r[m] = y[$ + 2 * (f + 1) + 2] * (u - 1 + p) + y[$ + 2 * (f + 1)] * (1 - u) + y[$ + 2] * (1 - p),
                    r[m + 1] = y[$ + 2 * (f + 1) + 3] * (u - 1 + p) + y[$ + 2 * (f + 1) + 1] * (1 - u) + y[$ + 3] * (1 - p))
            }
            ,
                ...
                try {
                    ...
                    for (var h = e.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, c = this._$uP, f = this._$6r, g = this._$3r, d = ot.tr, y = ot._$Ti, m = ot._$Pi, P = ot._$B, S = 0; S < h; S += 3) {
                        ...
                        at.USE_CACHED_POLYGON_IMAGE) {
                            ...
                            at.IGNORE_CLIP || ot.clip(u, d, n, k, O, b, R, F, C, N, E, x, A, I, w, D),
            ...
            ot.expandClip = function(t, e, i, r, o, n, s, a, _, h) {
                var l = s - o
                  ...
                  , C = h + c * v / L
                  , N = ot._$50;
                return null != e._$P2(N) && (ot.clipWithTransform(t, N, M, E, x, A, I, w, D, O, F, C, b, R),
                !0)
            }
            ,
            ...
            yt._$cr = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = yt._$9r(2 * e.length)).put(e),
                t._$oT(0)) : (t.clear(),
                t.put(e),
                t._$oT(0)),
                t
            ...
            yt._$mb = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = yt._$vb(2 * e.length)).put(e),
                t._$oT(0)) : (t.clear(),
                t.put(e),
                t._$oT(0)),
                t
            ...
            Mt.setup = function() {
                ...
                if ((i = t.indexOf("iPhone OS ")) >= 0)
                    r.os = "iPhone",
                    r._isIPhone = !0,
                    r.version = e(t, i + "iPhone OS ".length);
                else if ((i = t.indexOf("iPad")) >= 0) {
                    if ((i = t.indexOf("CPU OS")) < 0)
                        return void a._$li(" err : " + t + " @UtHtml5.setup()");
                    r.os = "iPad",
                    r._isIPad = !0,
                    r.version = e(t, i + "CPU OS ".length)
                } else
                    (i = t.indexOf("Android")) >= 0 ? (r.os = "Android",
                    r._isAndroid = !0,
                    r.version = e(t, i + "Android ".length)) : (r.os = "-",
                    r.version = -1)
            }
            ,
            at.init();
    ...
    82: function(t, e, i) {
        ...
        t.exports = {
            createDialogElement: function(t) {
                (n = document.createElement("div")).className = "live2d-widget-dialog-container",
